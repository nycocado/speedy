    ...
    class SpeedyHardwareInterface : public hardware_interface::SystemInterface
    {
        ...
        private:
            ...
            )
            {
                ...
                if (it != info.hardware_parameters.end())
                {
                    ...
                    if constexpr (std::is_same_v<T, bool>)
                    {
                        ...
                        std::transform(
                            val.begin(), val.end(), val.begin(), ::tolower
                        );
            ...
            rclcpp::Logger logger_ =
                rclcpp::get_logger("SpeedyHardwareInterface");
            ...
            struct
            {
                    ...
                    double deadband_m_s = 0.02;
                    double zero_timeout_s = 0.15;
            } cfg_pid_;
            ...
            double t_idle_rear_ = 0.0, t_idle_fl_ = 0.0, t_idle_fr_ = 0.0;
    };
} // namespace speedy_control
